...
public class GunCopy : MonoBehaviour //This was made because the previous gun script had a refence to 'PlayerControl' so my player would always shoot to the right
{
	...
	private KinematicPlayerControl myPlayerControl;    // Reference to the KinematicPlayerControl script.
	...
	void Awake()
	{
		...
		myPlayerControl = transform.root.GetComponent<KinematicPlayerControl>();
	}
	void Update()
	{
